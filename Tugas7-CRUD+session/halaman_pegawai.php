...
<body style="background-image:url(img/landing.jpg); background-size:cover">
    ...
    <div class="container">
        <div class="rounded-lg" style="position: auto; left: 25%; right: 25%; color: white; text-align: center; background-color:slategray; opacity: 85%;">
			...
			<p>Halo <b><?php echo $_SESSION['nama_user']; ?></b> Anda telah login dengan User <b><?php echo $_SESSION['role_user']; ?></b>.</p>
			<div class="page-header clearfix">
                <h2 class="pull-left">Informasi Produk</h2>
                <a href="create.php" class="btn btn-success pull-right">Tambah Baru</a>
                <a href="halaman_pegawai.php" class="btn btn-primary pull-right">Ulang</a>
            </div>
            <?php
                ...
                mysqli_close($link);
        	?>
			<center><a type="button" class="btn btn-danger" href="logout.php">Log Out</a><br/><br/></center>
		</div>
	</div>
</body>
</html>